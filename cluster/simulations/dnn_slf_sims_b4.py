...
class hyperparams_slf_b4:
    def __init__(self):
        self.net_pars = net_pars_slf_b4()
        self.train_pars = train_pars_slf_b4()
        self.norm_data_full = False
        self.id = f'4slf_optim_snr20_nmaevalMS_d{self.net_pars.depth}_w{self.net_pars.width}_o{self.train_pars.optim}_l{self.train_pars.lr}_{self.train_pars.loss_fun}_{self.net_pars.con}_d{self.net_pars.dropout}'
