...
from bayesian_optimization.simulation_params_sup_b5_BO import simulation_params_sup_b5_BO as simulation_params_sup_b5_BO
...
def run_BO_sims(snr):
    ...
    arg_sim = simulation_params_sup_b5_BO()
    ...
    ax_client.create_experiment(
        name="BO_sup_b5",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
