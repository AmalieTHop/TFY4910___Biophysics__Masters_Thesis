...
from bayesian_optimization.simulation_params_sup_b4_BO import simulation_params as simulation_params
...
def run_sims(snr):
    ...
    ax_client.create_experiment(
        name="BO_sup_b4_valHTnrmse",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
