...
from bayesian_optimization.simulation_params_slf_b11_BO import simulation_params as simulation_params
...
def run_sims(snr):
    ...
    # make directory
    dir_out = f'../../../simulations/BO_valHTnrmse/b{len(arg_sim.bvalues)}/snr{snr}/dnn_{arg_sim.learning}'
    ...
    ax_client = AxClient(generation_strategy=gs, random_seed=24)
    ax_client.create_experiment(
        name="BO_slf_b11_valHTnrmse",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
        ...
        objectives={
            "loss_valHT": ObjectiveProperties(minimize=True, threshold=0.045),
            "sum_nrmse_valHT": ObjectiveProperties(minimize=True, threshold=1.6)},
