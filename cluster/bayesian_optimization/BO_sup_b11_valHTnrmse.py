...
from bayesian_optimization.simulation_params_sup_b11_BO import simulation_params as simulation_params
...
def run_sims(snr):
    ...
    ax_client.create_experiment(
        name="BO_sup_b11_valHTnrmse",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
        ...
        objectives={"sum_nrmse_valHT": ObjectiveProperties(minimize=True, threshold=1.6)},
