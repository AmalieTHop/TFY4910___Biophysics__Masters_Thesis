...
from bayesian_optimization.simulation_params_slf_b5_BO import simulation_params as simulation_params
...
def run_sims(snr):
    ...
    ax_client.create_experiment(
        name="BO_slf_b5_valHTnrmse",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
        ...
        objectives={
            "loss_valHT": ObjectiveProperties(minimize=True, threshold=0.030),
