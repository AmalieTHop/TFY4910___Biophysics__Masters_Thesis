...
import bayesian_optimization.hyperparams_fixed_sup_BO as from_hyperparams_fixed_sup_BO
from bayesian_optimization.simulation_params_sup_b11_BO import simulation_params_sup_b11_BO as simulation_params_sup_b11_BO
...
def run_BO_sims(snr):
    ...
    arg_sim = simulation_params_sup_b11_BO()
    arg_sim = from_simulations_BO.checkarg_simulation_params_BO(arg_sim)

    # load hyperparameter
    arg_dnn = from_hyperparams_fixed_sup_BO.hyperparams_sup_BO()
    ...
    ax_client.create_experiment(
        name="BO_sup_b11",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
        ...
        objectives={"sum_nmae_valMS": ObjectiveProperties(minimize=True, threshold=1.0)},
