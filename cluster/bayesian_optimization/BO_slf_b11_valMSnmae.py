...
from bayesian_optimization.simulation_params_slf_b11_BO import simulation_params_slf_b11_BO as simulation_params_slf_b11_BO
...
def run_BO_sims(snr):
    ...
    arg_sim = simulation_params_slf_b11_BO()
    ...
    ax_client.create_experiment(
        name="BO_slf_b11",  # The name of the experiment.
        parameters=[
            {
                "name": "lr",
                "type": "range",
        ...
        objectives={
            "loss_valMS": ObjectiveProperties(minimize=True, threshold=0.045),
